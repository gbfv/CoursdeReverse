...
Les énoncés comme 
\mint{asm}{message db "Bonjour le monde", 10, 0} décrivent le contenu, octet par octet, de la mémoire à une position nommée "message". 
Les énoncés comme \mint{asm}{xor rax, rax} décrivent le contenu de la mémoire, mais en utilisant la syntaxe assembleur des instructions. Il eut été équivalent d'écrire : 
\mint{asm}{db 0x48, "1", 0xC0}
